...
The red lines highlight the jet emission. They were plotted by doing the Gaussian fit to each of the rows in the vicinity of the jet emission and taking the mean of those fits. The uncertainty of the resulting fits lies within the line thickness.
\label{fig:DFTau}}
\end{center}
\end{figure}
...
to each row of data in the figure. \bf{Black lines in the figure mark the peak
